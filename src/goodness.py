...
def evaluate_cf_list(cf_list, x, bb, y_val, max_nbr_cf, variable_features, continuous_features_all,
    ...
    if nbr_cf_ > 0:
        ...
        distance_l2_min_ = continuous_distance(x, cf_list, continuous_features_all, metric='euclidean', X=None,
                                               agg='min')
        ...
        distance_l2j_min_ = distance_l2j(x, cf_list, continuous_features_all, categorical_features_all, ratio_cont,
                                         agg='min')
        distance_mh_min_ = distance_mh(x, cf_list, continuous_features_all, categorical_features_all, X_train,
                                       ratio_cont, agg='min')

        distance_l2_max_ = continuous_distance(x, cf_list, continuous_features_all, metric='euclidean', X=None,
                                               agg='max')
        ...
        distance_l2j_max_ = distance_l2j(x, cf_list, continuous_features_all, categorical_features_all, ratio_cont,
                                         agg='max')
        distance_mh_max_ = distance_mh(x, cf_list, continuous_features_all, categorical_features_all, X_train,
                                       ratio_cont, agg='max')
        ...
        if len(cf_list) > 1:
            ...
            diversity_mh_ = diversity_mh(cf_list, continuous_features_all, categorical_features_all, X_train,
                                         ratio_cont)

            diversity_l2_min_ = continuous_diversity(cf_list, continuous_features_all, metric='euclidean', X=None,
                                                     agg='min')
            diversity_mad_min_ = continuous_diversity(cf_list, continuous_features_all, metric='mad', X=X_train,
                                                      agg='min')
            ...
            diversity_l2j_min_ = diversity_l2j(cf_list, continuous_features_all, categorical_features_all, ratio_cont,
                                               agg='min')
            diversity_mh_min_ = diversity_mh(cf_list, continuous_features_all, categorical_features_all, X_train,
                                             ratio_cont, agg='min')

            diversity_l2_max_ = continuous_diversity(cf_list, continuous_features_all, metric='euclidean', X=None,
                                                     agg='max')
            diversity_mad_max_ = continuous_diversity(cf_list, continuous_features_all, metric='mad', X=X_train,
                                                      agg='max')
            ...
            diversity_l2j_max_ = diversity_l2j(cf_list, continuous_features_all, categorical_features_all, ratio_cont,
                                               agg='max')
            diversity_mh_max_ = diversity_mh(cf_list, continuous_features_all, categorical_features_all, X_train,
                                             ratio_cont, agg='max')
        ...
        count_diversity_cate_ = count_diversity(cf_list, categorical_features_all, nbr_features,
...
def evaluate_cf_list_img_ts(cf_list, x, bb, y_val, max_nbr_cf, variable_features, X_train, X_test, nbr_features,
    ...
    if nbr_cf_ > 0:
        ...
        accuracy_knn_dist_ = accuracy_knn_dist_img_ts(x, x_flat, cf_list, cf_list_flat, bb, X_test, X_test_flat,
                                                      test_size=5)
